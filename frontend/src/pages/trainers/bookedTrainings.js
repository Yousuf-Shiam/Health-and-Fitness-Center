  ...
  useEffect(() => {
    const fetchBookings = async () => {
      try {
        ...
        const response = await fetch('${import.meta.env.VITE_REACT_APP_BACKEND_BASEURL}/api/bookings/trainer', {
          headers: {
  ...
  return (
    <>
      ...
      <div style={styles.container}>
        <h1 style={styles.heading}>Bookings for Your Trainings</h1>
        {bookings.length === 0 ? (
