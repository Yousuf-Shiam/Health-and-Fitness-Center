...
function TrainerProgramCreation() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('${import.meta.env.VITE_REACT_APP_BACKEND_BASEURL}/api/programs', {
        ...
        body: JSON.stringify({ ...programData, role: 'trainer' }), // Add role as 'trainer'
      });
  ...
  return (
    <>
      ...
      <div style={styles.container}>
        <h1 style={styles.heading}>Create a Training Program</h1>
        <p style={styles.subheading}>Fill out the form below to create a new training program for your clients.</p>
...
export default TrainerProgramCreation;